...
h=a,c.color(h)}},duration:{get:function(){return k},set:function(a){k=a,m.reset(k),c.duration(k)}},margin:{get:function(){return e},set:function(a){e.top=void 0!==a.top?a.top:e.top,e.right=void 0!==a.right?a.right:e.right,e.bottom=void 0!==a.bottom?a.bottom:e.bottom,e.left=void 0!==a.left?a.left:e.left}}}),a.utils.inheritOptions(b,c),a.utils.initOptions(b),b},a.models.timeline=function(b){"use strict";function c(b){b.length;b.each(function(i,k){m-j.left-j.right,n-j.top-j.bottom;u=d3.select(this),a.utils.initSVG(u);var l=new d(i);b=d3.select(this);var o=d3.scale.linear().domain([r,s]).range([0,m]),v=this.__chart__||d3.scale.linear().domain([0,1/0]).range(o.range());this.__chart__=o;var w=b.selectAll("rect.range").data(l.all());w.enter().append("rect").attr("class",function(a,b){return h(a,b)}).attr("data-time",function(a,b){return a.start_time}).attr("width",function(a,b){return f(o,a,b)}).attr("height",n).attr("x",function(a,b){return g(o,a)}).transition().duration(t).attr("width",function(a,b){return f(o,a,b)}).attr("x",function(a,b){return g(o,a)}),w.on("mouseover",function(a,b){p.elementMouseover({value:Math.round((a.end_time-a.start_time)/6e4),label:a.status,color:d3.select(this).style("fill")})}).on("mousemove",function(){p.elementMousemove({value:Math.round((i.end_time-i.start_time)/6e4),label:i.status,color:d3.select(this).style("fill")})}).on("mouseout",function(){p.elementMouseout({value:Math.round((i.end_time-i.start_time)/6e4),label:i.status,color:d3.select(this).style("fill")})}),w.transition().duration(t).attr("x",function(a,b){return g(o,a)}).attr("width",function(a,b){return f(o,a,b)}).attr("height",n);var x=function(a){return moment(new Date(parseInt(a))).format("h:mm A")},y=function(){for(var a=r,b=[];s>=a;)b.push(a),a+=36e5;return b},z=b.selectAll("g.tick").data(y(),function(a){return this.textContent||x(a)});if(k===q-1){b.append("line").attr("x1",o(r)).attr("y1",n+10).attr("x2",o(s)).attr("y2",n+10).attr("stroke-width",1).attr("stroke","black");var A=z.enter().append("g").attr("class","tick").attr("transform",e(v)).style("opacity",1e-6);A.append("line").attr("y1",n).attr("y2",7*n/6),A.append("text").attr("text-anchor","middle").attr("dy","1em").attr("y",n+20).text(x),A.transition().duration(t).attr("transform",e(o)).style("opacity",1);var B=z.transition().duration(t).attr("transform",e(o)).style("opacity",1);B.select("line").attr("y1",n).attr("y2",n+10),B.select("text").attr("y",n+20),z.exit().transition().duration(t).attr("transform",e(o)).style("opacity",1e-6).remove()}return c})}function d(a){this.startTimes=function(){return $(a.activities).map(function(a,b){return i(b.start_time)}).toArray()},this.endTimes=function(){return $(a.activities).map(function(a,b){return i(b.end_time)}).toArray()},this.all=function(){return $(a.activities).map(function(a,b){return{status:b.status,start_time:i(b.start_time),end_time:i(b.end_time)}}).toArray()}}function e(a){return function(b){return"translate("+a(b)+",0)"}}function f(a,b,c){var d=b.start_time,e=b.end_time;return Math.abs(a(e)-a(d))}function g(a,b){return a(b.start_time)}function h(a,b){return"activity "+a.status}function i(a){return a?moment.utc(a).toDate().getTime():0}var j={top:0,right:0,bottom:0,left:0},k="left",l=!1,m=380,n=30,o=null,p=d3.dispatch("elementMouseover","elementMouseout","elementMousemove"),q=void 0===b?0:b.length,r=(new Date).getTime(),s=(new Date).getTime(),t=0,u=null;return c.orient=function(a){return arguments.length?(k=a,l="right"==k||"bottom"==k,c):k},c.width=function(a){return arguments.length?(m=a,c):m},c.height=function(a){return arguments.length?(n=a,c):n},c.tickFormat=function(a){return arguments.length?(o=a,c):o},c.duration=function(a){return arguments.length?(t=a,c):t},c.dispatch=p,c.options=a.utils.optionsFunc.bind(c),c._options=Object.create({},{activities:{get:function(){return activities},set:function(a){activities=a}},tickFormat:{get:function(){return o},set:function(a){o=a}},margin:{get:function(){return j},set:function(a){j.top=void 0!==a.top?a.top:j.top,j.right=void 0!==a.right?a.right:j.right,j.bottom=void 0!==a.bottom?a.bottom:j.bottom,j.left=void 0!==a.left?a.left:j.left}},orient:{get:function(){return k},set:function(a){k=a,l="right"==k||"bottom"==k}},startTime:{get:function(){return r},set:function(a){r=new Date(a).getTime()}},endTime:{get:function(){return s},set:function(a){s=new Date(a).getTime()}}}),a.utils.initOptions(c),c},a.models.timelineChart=function(b){"use strict";function c(b){return b.each(function(f,h){var i=d3.select(this);a.utils.initSVG(i);var l=j-g.left-g.right,m=k-g.top-g.bottom;c.update=function(){c(b)},c.container=this;var r=i.selectAll("g.nv-wrap.nv-timelineChart").data([f]),s=r.enter().append("g").attr("class","nvd3 nv-wrap nv-timelineChart"),t=s.append("g"),u=r.select("g");t.append("g").attr("class","nv-timelineWrap"),t.append("g").attr("class","nv-titles");var v=d3.scale.linear().domain([o,p]).range([0,j]),w=this.__chart__||d3.scale.linear().domain([0,1/0]).range(v.range());e.width(l).height(m).options({width:j,height:k,startTime:o,endTime:p,margin:g});var x=u.select(".nv-timelineWrap");d3.transition(x).call(e,f);var y=function(a){return moment(new Date(parseInt(a))).format("h:mm A")},z=function(){for(var a=o,b=[];p>=a;)b.push(a),a+=36e5;return b},A=u.selectAll("g.tick").data(z(),function(a){return this.textContent||y(a)});if(h===n-1){u.append("line").attr("x1",v(o)).attr("y1",k+10).attr("x2",v(p)).attr("y2",k+10).attr("stroke-width",1).attr("stroke","black");var B=A.enter().append("g").attr("class","tick").attr("transform",d(w)).style("opacity",1e-6);B.append("line").attr("y1",k).attr("y2",7*k/6),B.append("text").attr("text-anchor","middle").attr("dy","1em").attr("y",k+20).text(y),B.transition().duration(q).attr("transform",d(v)).style("opacity",1);var C=A.transition().duration(q).attr("transform",d(v)).style("opacity",1);C.select("line").attr("y1",k).attr("y2",k+10),C.select("text").attr("y",k+20),A.exit().transition().duration(q).attr("transform",d(v)).style("opacity",1e-6).remove()}}),d3.timer.flush(),c}function d(a){return function(b){return"translate("+a(b)+",0)"}}var e=a.models.timeline(),f=a.models.tooltip(),g={top:0,right:0,bottom:0,left:0},h="left",i=!1,j=380,k=30,l=null,m=d3.dispatch("elementMouseover","elementMouseout","elementMousemove"),n=void 0===b?0:b.length,o=(new Date).getTime(),p=(new Date).getTime(),q=0;return f.duration(0).headerEnabled(!1).valueFormatter(function(a,b){return a+" minutes"}),e.dispatch.on("elementMouseover.tooltip",function(a){a.series={key:a.label,value:a.value,color:a.color},f.data(a).hidden(!1)}),e.dispatch.on("elementMouseout.tooltip",function(a){f.hidden(!0)}),e.dispatch.on("elementMousemove.tooltip",function(a){f()}),c.timeline=e,c.dispatch=m,c.tooltip=f,c.options=a.utils.optionsFunc.bind(c),c._options=Object.create({},{width:{get:function(){return j},set:function(a){j=a}},height:{get:function(){return k},set:function(a){k=a}},tickFormat:{get:function(){return l},set:function(a){l=a}},ticks:{get:function(){return ticks},set:function(a){ticks=a}},noData:{get:function(){return noData},set:function(a){noData=a}},margin:{get:function(){return g},set:function(a){g.top=void 0!==a.top?a.top:g.top,g.right=void 0!==a.right?a.right:g.right,g.bottom=void 0!==a.bottom?a.bottom:g.bottom,g.left=void 0!==a.left?a.left:g.left}},orient:{get:function(){return h},set:function(a){h=a,i="right"==h||"bottom"==h}},startTime:{get:function(){return o},set:function(a){o=new Date(a).getTime()}},endTime:{get:function(){return p},set:function(a){p=new Date(a).getTime()}}}),a.utils.inheritOptions(c,e),a.utils.initOptions(c),c},a.version="1.8.1-dev"}();
