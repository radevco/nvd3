...
h=a,c.color(h)}},duration:{get:function(){return k},set:function(a){k=a,m.reset(k),c.duration(k)}},margin:{get:function(){return e},set:function(a){e.top=void 0!==a.top?a.top:e.top,e.right=void 0!==a.right?a.right:e.right,e.bottom=void 0!==a.bottom?a.bottom:e.bottom,e.left=void 0!==a.left?a.left:e.left}}}),a.utils.inheritOptions(b,c),a.utils.initOptions(b),b},a.models.timeline=function(b){"use strict";function c(b){b.length;b.each(function(i,k){m-j.left-j.right,n-j.top-j.bottom;u=d3.select(this),a.utils.initSVG(u);var l=new d(i);b=d3.select(this);var o=d3.scale.linear().domain([r,s]).range([0,m]),p=this.__chart__||d3.scale.linear().domain([0,1/0]).range(o.range());this.__chart__=o;var v=b.selectAll("rect.range").data(l.all());v.enter().append("rect").attr("class",function(a,b){return h(a,b)}).attr("data-time",function(a,b){return a.start_time}).attr("width",function(a,b){return f(o,a,b)}).attr("height",n).attr("x",function(a,b){return g(o,a)}).transition().duration(t).attr("width",function(a,b){return f(o,a,b)}).attr("x",function(a,b){return g(o,a)}),v.transition().duration(t).attr("x",function(a,b){return g(o,a)}).attr("width",function(a,b){return f(o,a,b)}).attr("height",n);var w=function(a){return moment(new Date(parseInt(a))).format("h:mm A")},x=function(){for(var a=r,b=[];s>=a;)b.push(a),a+=36e5;return b},y=b.selectAll("g.tick").data(x(),function(a){return this.textContent||w(a)});if(k===q-1){b.append("line").attr("x1",o(r)).attr("y1",n+10).attr("x2",o(s)).attr("y2",n+10).attr("stroke-width",1).attr("stroke","black");var z=y.enter().append("g").attr("class","tick").attr("transform",e(p)).style("opacity",1e-6);z.append("line").attr("y1",n).attr("y2",7*n/6),z.append("text").attr("text-anchor","middle").attr("dy","1em").attr("y",n+20).text(w),z.transition().duration(t).attr("transform",e(o)).style("opacity",1);var A=y.transition().duration(t).attr("transform",e(o)).style("opacity",1);A.select("line").attr("y1",n).attr("y2",n+10),A.select("text").attr("y",n+20),y.exit().transition().duration(t).attr("transform",e(o)).style("opacity",1e-6).remove()}return c})}function d(a){this.startTimes=function(){return $(a.activities).map(function(a,b){return i(b.start_time)}).toArray()},this.endTimes=function(){return $(a.activities).map(function(a,b){return i(b.end_time)}).toArray()},this.all=function(){return $(a.activities).map(function(a,b){return{status:b.status,start_time:i(b.start_time),end_time:i(b.end_time)}}).toArray()}}function e(a){return function(b){return"translate("+a(b)+",0)"}}function f(a,b,c){var d=b.start_time,e=b.end_time;return Math.abs(a(e)-a(d))}function g(a,b){return a(b.start_time)}function h(a,b){return"activity "+a.status}function i(a){return a?moment.utc(a).toDate().getTime():0}var j={top:0,right:0,bottom:0,left:0},k="left",l=!1,m=380,n=30,o=null,p=d3.dispatch("elementMouseover","elementMouseout","elementMousemove"),q=b.length,r=(new Date).getTime(),s=(new Date).getTime(),t=0,u=null;return c.orient=function(a){return arguments.length?(k=a,l="right"==k||"bottom"==k,c):k},c.width=function(a){return arguments.length?(m=a,c):m},c.height=function(a){return arguments.length?(n=a,c):n},c.tickFormat=function(a){return arguments.length?(o=a,c):o},c.duration=function(a){return arguments.length?(t=a,c):t},c.dispatch=p,c.options=a.utils.optionsFunc.bind(c),c._options=Object.create({},{activities:{get:function(){return activities},set:function(a){activities=a}},tickFormat:{get:function(){return o},set:function(a){o=a}},margin:{get:function(){return j},set:function(a){j.top=void 0!==a.top?a.top:j.top,j.right=void 0!==a.right?a.right:j.right,j.bottom=void 0!==a.bottom?a.bottom:j.bottom,j.left=void 0!==a.left?a.left:j.left}},orient:{get:function(){return k},set:function(a){k=a,l="right"==k||"bottom"==k}},startTime:{get:function(){return r},set:function(a){r=new Date(a).getTime()}},endTime:{get:function(){return s},set:function(a){s=new Date(a).getTime()}}}),a.utils.initOptions(c),c},a.version="1.8.1-dev"}();
